...
# node ./defi-direct-ui/cd-pipeline/prod-deployment/prod-hosts-builder.js
...
kubectl apply -f ./defi-direct-ui/cd-pipeline/prod-deployment/k8s/prod-deployment.ingress.yaml
return_code=$?
