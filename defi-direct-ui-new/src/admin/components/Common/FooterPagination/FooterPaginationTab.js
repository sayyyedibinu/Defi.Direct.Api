...
import './FooterPaginationStyleTab.css';


export default class FooterPaginationTabComponent extends React.Component{
    getFrom = () => {
    ...
    render(){
        return(
            <div className="tabpaginationWrapper">
                {
                    ...
                    <ReactPaginate previousLabel={<i className="material-icons">keyboard_arrow_left</i>}
                       ...
                       containerClassName={"tabpagination"}
                       subContainerClassName={"pages tabpagination"}
                       activeClassName={"active appSecondaryBGClr"} />
                }


               <span className="tabrowsPer">
                    Rows per page 
