...
import './deleteConfirmationModalStyle.css';

import Modal from '@material-ui/core/Modal';
import Button from '@material-ui/core/Button';
import Grid from '@material-ui/core/Grid';

export default class deleteConfirmationModalComponent extends React.Component{
    constructor(props){
        super(props);
        this.state = {};
    }
                ...
                <Grid container spacing={0}>
                    <Grid item xs={12} sm={10} md={9} lg={6} className="disableModalWrapper">
                        <div className="disableModalContainer">
                            ...
                            <Grid container spacing={0}>
                                <Grid item xs={12}>
                                    <h2 className="disableModalHeader1">Are you sure to delete this site?</h2>
                                </Grid>
                                <Grid item xs={12}>
